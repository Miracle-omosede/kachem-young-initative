...
const Projects = () => {
        ...
        <div className='grid grid-cols-12 gap-[31px]'>
          <div className='col-span-8 flex flex-col gap-[64px]'>
            <div className='flex flex-col gap-[25px]'>
              ...
              A community Development Acceleration project, designed to manually evaluate our impact across host communities, literacy centres and to galvanize community collaboration towards a specific developmental project, - accessible education and healthcare.   <a href='#' className='text-primary'>Learn more</a>
              </p>
            </div>
  ...
  <div className='flex flex-row justify-between items-center my-2'>
      ...
      >
        <span className="flex-none items-center justify-center w-full">Our Projects</span>
        <span className="flex items-center justify-center">
        <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.293 0.293031C6.48053 0.10556 6.73484 0.000244141 7 0.000244141C7.26516 0.000244141 7.51947 0.10556 7.707 0.293031L11.707 4.29303C11.8945 4.48056 11.9998 4.73487 11.9998 5.00003C11.9998 5.26519 11.8945 5.5195 11.707 5.70703L7.707 9.70703C7.5184 9.88919 7.2658 9.98998 7.0036 9.9877C6.7414 9.98543 6.49059 9.88026 6.30518 9.69485C6.11977 9.50944 6.0146 9.25863 6.01233 8.99643C6.01005 8.73423 6.11084 8.48163 6.293 8.29303L8.586 6.00003H1C0.734784 6.00003 0.48043 5.89467 0.292893 5.70714C0.105357 5.5196 0 5.26525 0 5.00003C0 4.73481 0.105357 4.48046 0.292893 4.29292C0.48043 4.10539 0.734784 4.00003 1 4.00003H8.586L6.293 1.70703C6.10553 1.5195 6.00021 1.26519 6.00021 1.00003C6.00021 0.734866 6.10553 0.480558 6.293 0.293031Z" fill="#F65308"/>
</svg>
